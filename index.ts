export const isbnTag = (isbn: string) => { // takes a string as an argument and returns a boolean value
...
console.log(isbnTag("1112223339")); // this is a valid ISBN
console.log(isbnTag("123456789X")); // this is a valid ISBN
console.log(isbnTag("0111111111")); // this is an invalid ISBN
console.log(isbnTag("X123456789")); // this is an invalid ISBN